<template>
    <div class="client">
            ...
            <el-tab-pane label="客户端列表" name="first" class="table_padding">
                <el-form :inline="true" class="demo-form-inline search-style" size="small">
                    ...
                    <el-form-item>
                        ...
                        <el-button type="primary" @click.native="initClientData()">添加客户端配置</el-button>
                    </el-form-item>
                </el-form>
                    ...
                    >
                        <template slot-scope="scope">
                            <el-button type="primary" icon="el-icon-edit" size="mini"
                                       @click.native="editClient(clientTableData[scope.$index]['id'])">编辑
                            </el-button>
        ...
        <el-dialog
                title="客户端设置"
                :visible.sync="clientData.modelFormVisible"
                width="30%"
        >
            <el-form>
            ...
            <span slot="footer" class="dialog-footer">
                    <el-button @click="clientData.modelFormVisible = false" size="small">取 消</el-button>
    ...
    export default {
        ...
        methods: {
                ...
                this.$axios.post(this.$api.addCommonConfigApi, {
                    ...
                    'desc': this.clientData.desc,
                        ...
                        if (response.data['status'] === 0) {
                            ...
                            this.findClient();
                            this.clientData.modelFormVisible = false;
                        }
                    }
                )
            },
            ...
            initClientData() {
                ...
                this.clientData.modelFormVisible = true;
            },
            editClient(id) {
