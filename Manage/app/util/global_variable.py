...
WIKI_FILE_ADDRESS = os.path.abspath('..') + r'/wiki/'
...
def _check_file_path():
    ...
    if not os.path.exists(NOTES_ADDRESS):
        os.makedirs(NOTES_ADDRESS)
    if not os.path.exists(WIKI_FILE_ADDRESS):
        os.makedirs(WIKI_FILE_ADDRESS)
